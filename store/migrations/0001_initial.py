    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('B', 'Bronze'), ('S', 'Silver'), ('G', 'Gold')], max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Promotion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'P'), ('C', 'C'), ('F', 'F')], default='P', max_length=50)),
